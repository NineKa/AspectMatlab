...
public final class ELDivTrans extends BinaryTrans {
    public ELDivTrans(TransformerArgument argument, ELDivExpr elDivExpr) {
        super(argument, elDivExpr);
    }
    ...
    public Pair<Expr, List<Stmt>> copyAndTransform() {
        if (this.hasTransformOnCurrentNode()) {
            ...
            AssignStmt t2Assign = buildAssignStmt.apply(
                    ...
                    new ELDivExpr(new NameExpr(new Name(t0Name)), new NameExpr(new Name(t1Name)))
            );
            ...
            Expr copiedLHS = lhsTransformResult.getValue0();
            Expr copiedRHS = rhsTransformResult.getValue0();
            ELDivExpr copiedNode = (ELDivExpr) this.originalNode.copy();
