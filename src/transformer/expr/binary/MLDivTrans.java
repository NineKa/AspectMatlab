...
public final class MLDivTrans extends BinaryTrans {
    public MLDivTrans(TransformerArgument argument, MLDivExpr mlDivExpr) {
        super(argument, mlDivExpr);
    }
    ...
    public Pair<Expr, List<Stmt>> copyAndTransform() {
        if (this.hasTransformOnCurrentNode()) {
            ...
            AssignStmt t2Assign = buildAssignStmt.apply(
                    ...
                    new MLDivExpr(new NameExpr(new Name(t0Name)), new NameExpr(new Name(t1Name)))
            );
            ...
            Expr copiedLHS = lhsTransformResult.getValue0();
            Expr copiedRHS = rhsTransformResult.getValue0();
            MLDivExpr copiedNode = (MLDivExpr) this.originalNode.copy();
