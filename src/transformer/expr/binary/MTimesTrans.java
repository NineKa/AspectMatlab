...
public final class MTimesTrans extends BinaryTrans {
    public MTimesTrans(TransformerArgument argument, MTimesExpr mTimesExpr) {
        super(argument, mTimesExpr);
    }
    ...
    public Pair<Expr, List<Stmt>> copyAndTransform() {
        if (this.hasTransformOnCurrentNode()) {
            ...
            AssignStmt t2Assign = buildAssignStmt.apply(
                    ...
                    new MTimesExpr(new NameExpr(new Name(t0Name)), new NameExpr(new Name(t1Name)))
            );
