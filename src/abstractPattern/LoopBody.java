...
public class LoopBody implements IPattern {
    ...
    public IReport getValidationReport(String pFilePath) {
        ...
        if (this.getLoopNameSignature().equals("..")) {
            retReport.AddError(
                    ...
                    "wildcard '..' is not a valid matcher in loop body pattern (use '*' instead)"
            );
        }
    ...
    public Class<? extends ASTNode> getASTNodeClass() { return PatternLoopBody.class; }
